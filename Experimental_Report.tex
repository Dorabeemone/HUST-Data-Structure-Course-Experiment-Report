...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=\linewidth]{images/destroy-clear-compare.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=\linewidth]{images/prior-next.png}
	\caption{前驱与后继流程示意}
\end{figure}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=\linewidth]{images/insert-delete.png}
	\caption{插入与删除}
\end{figure}
\newpage
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=\linewidth]{images/reverse.png}
	\caption{翻转}
\end{figure}
\newpage
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/remove-nth-from-end.png}
	\caption{删除倒数第N个}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/sort.png}
	\caption{排序}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/file-save-load.png}
	\caption{文件存取}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/interaction.png}
	\caption{交互}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/multi-table.png}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.5\linewidth]{images/ui-example.png}
	\caption{界面示例}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.4\linewidth]{images/frontend.png}
	\caption{前端控制流}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.85\linewidth]{images/adjacency-list.png}
	\caption{邻接表数据结构示意图}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/destroy-graph.png}
	\caption{销毁图}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/locate-putvex.png}
	\caption{查找与赋值}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/first-adjvex.png}
	\caption{第一邻接点}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/next-adjvex.png}
	\caption{下一邻接点}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.85\linewidth]{images/insert-delete-arc.png}
	\caption{插入弧与删除弧}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\linewidth]{images/dfs-flow.png}
	\caption{DFS算法流程示意图}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{images/dfs-structure.png}
	\caption{DFS数据结构示意图}
\end{figure}
\newpage
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\linewidth]{images/bfs-flow.png}
    \caption{BFS流程图}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{images/bfs-structure.png}
	\caption{BFS结构示意图}
\end{figure}
\newpage
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\linewidth]{images/vertices-less-than-k.png}
	\caption{距离小于K的顶点集合}
\end{figure}
\newpage
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.6\linewidth]{images/shortest-path.png}
	\caption{最短路径算法}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/connected-components.png}
	\caption{连通分量}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/file-structure.png}
	\caption{存储结构图}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{images/file-storage.png}
	\caption{文件操作流程图}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/multi-graph-structure.png}
	\caption{多图管理结构图}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{images/multi-graph-control.png}
	\caption{多图管理交互控制}
\end{figure}
